...
public class XMLConfigBuilder extends BaseBuilder {
     ...
     * <plugins>
     *     <plugin interceptor="cn.myth.mybatis.test.plugin.TestPlugin">
    ...
    private void pluginElement(Element parent) throws Exception {
        ...
        for (Element element : elements) {
            ...
            // 获取插件实现类并实例化：cn.myth.mybatis.test.plugin.TestPlugin
     ...
     *
     *   <mapper class="cn.myth.mybatis.test.dao.IUserDao">
     * </mappers>
     */
